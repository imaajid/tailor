...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Booking Form</h6>
                    <form class="forms-sample" method="POST" action="{{ route('bookings.store') }}" >
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date datepicker" id="datePickerExample">
                                <input type="text" name="booking_date" class="form-control"><span class="input-group-addon"><i data-feather="calendar"></i></span>
                            </div>
                        </div>
