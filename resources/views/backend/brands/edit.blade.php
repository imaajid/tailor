...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Brand Edit Form</h6>
                    <form class="forms-sample" method="POST" action="{{ route('brands.update', $brand->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-xs-12">
                                <input type="text" id="image" class="form-control file-upload-info" disabled=""
                                       placeholder="Upload Image" name="image" value="{{$brand->image}}">
